...
采用纪实编辑式双栏，并复用“关于 → 我们的团队”部分已有的 Nate 竖幅肖像。

### 桌面布局

开屏使用约 7:5 的双栏网格并顶部对齐：

- 左栏为主叙事：主标题、项目起源导语、两段成长路径正文；
- 右栏上方为 Nate 的 4:5 竖幅肖像及简短图注；
- 右栏下方为带橙色竖线的“Nate 的邀请”、两段邀请文字和署名。
...
照片保持 4:5 比例，并缩减文字区与照片区之间的间距，避免首屏形成松散断层。
...
- 照片使用已有 `nate-founder.jpg`，提供中英文替代文本和图注；
