    ...
    >
      <div className="home-editorial-shell home-programs-carousel__shell">
        <HomeReveal className="home-programs-carousel__heading">
          <div>
            <p className="home-section-kicker">{t('我们的项目', 'Our programmes')}</p>
            <h2>{t('阿柑少年可以如何参与', "How to take part in R'gan Junior")}</h2>
          </div>
        ...
        <HomeFadeCarousel
          ...
          renderNavigation={({ activeIndex, goTo }) => (
            <div className="home-programs-carousel__navigation" role="group" aria-label={t('选择项目', 'Choose a programme')}>
