            ...
            <Reveal>
              <figure className="overflow-hidden bg-primary-foreground/10">
                <img
                  ...
                  alt={t('在铁牛村共同生活的阿柑青年合照', "Young adults of R'gan living together in Tieniu Village")}
                  width="1080"
                  height="720"
                  loading="lazy"
            ...
            <Reveal delay={0.08}>
              ...
              <p className="mt-7 max-w-2xl text-base leading-9 text-primary-foreground/76 md:text-lg md:leading-10">
                {t(
                  ...
                  "Nate's understanding of land, food, and community grew through years of daily life with the Quinta community and the young adults of R'gan. They farmed, cooked, cared for the land and one another—and later stood beside the teenagers as they learned to research, organize, and act.",
                )}
              </p>
            </Reveal>
          </div>
